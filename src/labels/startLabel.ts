...
const startLabel = newLabel(
  ...
  [
    ...
    async () => {
      ...
      narration.dialogue = {
        character: sly,
        text: `Wow, that was a good handshake...`,
      };
    },
    async () => {
      await showImageContainer("sly", [
    ...
    async () => {
      ...
      narration.dialogue = {
        character: mc,
        text: `O-*kay*, I'm gonna go get settled in-`,
      };
    },
    async () => {
      await showImageContainer("sly", [
...
const secondPart = newLabel("second_part", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `We're not actually related.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `And *you're* just a sophomore!`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `Um... why did you switch degrees?`,
    };
  },
  async () => {
    await showImageContainer("james", [
    ...
    narration.dialogue = {
      character: sly,
      text: `My mom was all in the medical field,`,
    };
  },
  async () => {
    await showImageContainer("steph", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `They were actually her siblings.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `So I'm trying out architecture now.`,
    };
  },
  async () => {
    await showImageContainer("sly", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `Why not do that at a community college?`,
    };
  },
  async () => {
    await showImageContainer("sly", [
    ...
    narration.dialogue = {
      character: steph,
      text: `Did you get a full ride or something?`,
    };
  },
  async () => {
    await showImageContainer("steph", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `It's no worry if you don't,`,
    };
  },
  async () => {
    await showImageContainer("sly", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `Why? ${mc.name}'ll never meet him.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: steph,
      text: `I'm going for childhood education!`,
    };
  },
  async () => {
    await showImageContainer("sly", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `Hey, *I* wouldn't let you go anyway.`,
    };
  },
  async () => {
    await showImageContainer("james", [
    ...
    narration.dialogue = {
      character: steph,
      text: `...we'd see each other still.`,
    };
  },
  async () => {
    await showImageContainer("james", [
    ...
    narration.dialogue = {
      character: james,
      text: `I'm going for computer science.`,
    };
  },
  async () => {
    await showImageContainer("james", [
    ...
    narration.dialogue = {
      character: mc,
      text: `Oh, cool! You like computers?`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `...I think you said that wrong.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `So, what snacks did you bring?`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `...I had to do all the cooking as a kid.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `I can do... I don't need... I mean...`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: james,
      text: `${sly.name}, I am so out of the loop!`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `Is that why your parents sent you here?`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  () => {
    narration.dialogue = {
      character: mc,
      text: `...Mom committed suicide because of me...`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `She couldn't have that. I'd just royally`,
    };
  },
  async () => {
    await showImageContainer("steph", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `Those were the last words I heard from her.`,
    };
  },
  async () => {
    await showImageContainer("sly", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `...I never got another chance.`,
    };
  },
  () => {
    narration.dialogue = {
  ...
  async () => {
    ...
    narration.dialogue = {
      character: mc,
      text: `I don't want to look at any of them.`,
    };
  },
  () => {
  ...
  () => {
    narration.dialogue = {
      character: sly,
      text: `You don't really want us to leave, do you?`,
    };
  },
  () => {
    narration.dialogue = { character: mc, text: `?!?!` };
  ...
  () => {
    narration.dialogue = {
      character: mc,
      text: `...I look like such an idiot.`,
    };
  },
  () => {
    narration.dialogue = {
  ...
  () => {
    narration.dialogue = {
      character: steph,
      text: `You did the best you knew how.`,
    };
  },
  () => {
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `So, be honest with us right now.`,
    };
  },
  async () => {
    await showImageContainer("james", [
  ...
  async () => {
    ...
    narration.dialogue = {
      character: sly,
      text: `Because I'm willing to give you a shot.`,
    };
  },
  async () => {
    await showImageContainer("james", [
